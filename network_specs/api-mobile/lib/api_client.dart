...
class ApiClient {
  ApiClient({this.basePath = 'https://virtserver.swaggerhub.com/nbaklanov-issart/PetProjectAPI/1.0.0'}) {
  ...
  static dynamic _deserialize(dynamic value, String targetType, {bool growable}) {
    try {
      switch (targetType) {
        ...
        case 'GeoPosition':
          return GeoPosition.fromJson(value);
        case 'LossAnnouncement':
          return LossAnnouncement.fromJson(value);
        case 'NewLossAnnouncement':
          return NewLossAnnouncement.fromJson(value);
        case 'PetTypes':
          return PetTypesTypeTransformer().decode(value);
        case 'UserEmailLogin':
          return UserEmailLogin.fromJson(value);
        case 'UserEmailRegister':
          return UserEmailRegister.fromJson(value);
        case 'UserLoginTokens':
          return UserLoginTokens.fromJson(value);
        default:
          Match match;
